...
const App = () => {
    ...
    useEffect(() => window.scroll({ top: 1448 }) ,[]);
    useEffect(() => {
    ...
    const breaking_point_desktop = useMediaQuery({
                  ...
                  c-47.8,0-91-19.4-122.3-50.7"></path>
                                <g id="Dots" className="dots-nav">
                                    <g>
                                        <path
                                            ...
                                            d="M88.8,75c-3.3,0-6,2.7-6,6s2.7,6,6,6s6-2.7,6-6S88.1,75,88.8,75z"></path>
                                    </g>
                                    <g>
                                        <path
                                            className="dotsstro"
                                            ...
                                            d="M88.8,75c-3.3,0-6,2.7-6,6s2.7,6,6,6s6-2.7,6-6S90.9,75,88.2,75z"></path>
                                    </g>
                                </g>
                                <g id="Dots1" className="dots-nav">
                                    <g>
                                        <path
                                            className={
                                                top_p_text[8] > 1
                                                    ? "dotsst dotsfill1 progressdelay"
                                                    : "dotsst dotsfill1 normaldots"
                                            }
                                    ...
                                    <g>
                                        <path
                                            className={
                                                top_p_text[8] > 1
                                                    ? "dotsstro1 progressdelay2"
                                                    : "dotsstro1 normaldots2"
                                            }
                                            style={{
                                                fill: "none",
                                                stroke: "rgb(255, 255, 255)",
                                ...
                                <g id="Dots2" className="dots-nav">
                                    <g>
                                        <path
                                            className={
                                                top_p_text[8] > 2
                                                    ? "dotsst dotsfill2 progressdelay"
                                                    : "dotsst dotsfill2 normaldots"
                                            }
                                            d="M325.8,75c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S328,75,325.8,75z"></path>
                                    </g>
                                    <g>
                                        <path
                                            className={
                                                top_p_text[8] > 2
                                                    ? "dotsstro2 progressdelay2"
                                                    : "dotsstro2 normaldots2"
                                            }
                                            style={{
                                                fill: "none",
                                                stroke: "rgb(255, 255, 255)",
                                            ...
                                            d="M325.8,75c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S327.9,74,325.9,75z"></path>
                                    </g>
                                </g>
                                <g id="Dots3" className="dots-nav">
                                    <g>
                                        <path
                                            className={
                                                top_p_text[8] > 3
                                                    ? "dotsst dotsfill3 progressdelay"
                                                    : "dotsst dotsfill3 normaldots"
                                            }
                                            d="M380.8,200c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S385.1,200,380.8,200z"></path>
                                    </g>
                                    <g>
                                        <path
                                            className={
                                                top_p_text[8] > 3
                                                    ? "dotsstro3 progressdelay2"
                                                    : "dotsstro3 normaldots2"
                                            }
                                            style={{
                                                fill: "none",
                                                stroke: "rgb(255, 255, 255)",
                                            ...
                                            d="M380.8,200c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S380.9,199,380.8,200z"></path>
                                    </g>
                                </g>
                                <g id="Dots4" className="dots-nav">
                                    <g>
                                        <path
                                            className={
                                                top_p_text[8] > 4
                                                    ? "dotsst dotsfill4 progressdelay"
                                                    : "dotsst dotsfill4 normaldots"
                                            }
                                            d="M325.8,325c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S328.1,325,325.8,325z"></path>
                                    </g>
                                    <g>
                                        <path
                                            className={
                                                top_p_text[8] > 4
                                                    ? "dotsstro4 progressdelay2"
                                                    : "dotsstro4 normaldots2"
                                            }
                                            style={{
                                                fill: "none",
                                                stroke: "rgb(255, 255, 255)",
                                            ...
                                            d="M325.8,325c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S325.1,324,327.8,326z"></path>
                                    </g>
                                </g>
                                <g id="Dots5" className="dots-nav">
                                    <g>
                                        <path
                                            className={
                                                top_p_text[8] > 5
                                                    ? "dotsst dotsfill5 progressdelay"
                                                    : "dotsst dotsfill5 normaldots"
                                            }
                                            d="M206.8,375c-3.3,0-6,2.7-6,6s2.7,6,6,6s6-2.7,6-6S210.1,375,206.8,375z"></path>
                                    </g>
                                    <g>
                                        <path
                                            className={
                                                top_p_text[8] > 5
                                                    ? "dotsstro5 progressdelay2"
                                                    : "dotsstro5 normaldots2"
                                            }
                                            style={{
                                                fill: "none",
                                                stroke: "rgb(255, 255, 255)",
                                ...
                                <g id="Dots6" className="dots-nav">
                                    <g>
                                        <path
                                            className={
                                                top_p_text[8] > 6
                                                    ? "dotsst dotsfill6 progressdelay"
                                                    : "dotsst dotsfill6 normaldots"
                                            }
                                            d="M88.8,325c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S88.1,325,88.8,325z"></path>
                                    </g>
                                    <g>
                                        <path
                                            className={
                                                top_p_text[8] > 6
                                                    ? "dotsstro6 progressdelay2"
                                                    : "dotsstro6 normaldots2"
                                            }
                                            style={{
                                                fill: "none",
                                                stroke: "rgb(255, 255, 255)",
                                            ...
                                            d="M88.8,325c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S90.1,324,88.9,325z"></path>
                                    </g>
                                </g>
                            </svg>
                        </div>
                        <div
                            ...
                            <TextTransition
                                ...
                                springConfig={{ stiff: 50, gentle: 20 }}
                                noOverflow>
                                {top_p_text[0]}
                            </TextTransition>
                            <TextTransition
                                style={{ fontWeight: "1000", fontSize: "60px" , marginTop:"30px"}}
                                direction={text_transition_direction}
                                springConfig={{ stiff: 50, gentle: 20 }}
                                noOverflow>
                                {top_p_text[1]}
                        ...
                        <div
                            ...
                            <TextTransition
                                ...
                                direction={text_transition_direction}
                                springConfig={{ stiff: 50, damping: 20 }}
                                noOverflow>
                                {top_p_text[3]}
                            </TextTransition>
                            <TextTransition
                        ...
                        <div className="item" style={{ width: "100%" }}>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <h1>ABC 123</h1>
                                    <p>
                                        This is sample text for ABC 123. This is
                                        sample text for ABC 123.
                                    </p>
                                    <br />
                        ...
                        <div className="item" style={{ width: "100%" }}>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <h1>XYZ 123</h1>
                                    <p>
                                        This is sample text for XYZ 123. This is
                                        sample text for ABC 123.
                                    </p>
                                    <br />
                                    <div style={{ display: "flex" }}>
